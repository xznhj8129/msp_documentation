...
def generate_python_code(all_data):
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Generate Python Enums/Defines from C Headers')

    arguments = parser.parse_args()

    all_extracted_data = {}

    src_base_path = os.path.abspath("")
    files_processed = 0
    files_with_data = 0
    ...
    python_code = generate_python_code(all_extracted_data)
