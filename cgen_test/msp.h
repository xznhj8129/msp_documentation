...
typedef struct MSP_PACKED msp_MSP_API_VERSION_reply_t {
...
typedef struct MSP_PACKED msp_MSP_FC_VARIANT_reply_t {
...
typedef struct MSP_PACKED msp_MSP_FC_VERSION_reply_t {
...
typedef struct MSP_PACKED msp_MSP_BOARD_INFO_reply_t {
    char boardIdentifier[4];  // 4-character UPPER CASE board identifier (`TARGET_BOARD_IDENTIFIER`)
    int16_t hardwareRevision;  // Hardware revision number. 0 if not detected (`USE_HARDWARE_REVISION_DETECTION`)
...
typedef struct MSP_PACKED msp_MSP_BUILD_INFO_reply_t {
...
typedef struct MSP_PACKED msp_MSP_INAV_PID_reply_t {
    uint8_t legacyAsyncProcessing;  // Legacy, unused. Always 0
    int16_t legacyAsyncValue1;  // Legacy, unused. Always 0
...
typedef struct MSP_PACKED msp_MSP_SET_INAV_PID_request_t {
...
typedef struct MSP_PACKED msp_MSP_NAME_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_NAME_request_t {
...
typedef struct MSP_PACKED msp_MSP_NAV_POSHOLD_reply_t {
    uint8_t userControlMode;  // Navigation user control mode NAV_GPS_ATTI (0) or NAV_GPS_CRUISE (1)
    int16_t maxAutoSpeed;  // Max speed in autonomous modes (`navConfig()->general.max_auto_speed`) | units: cm/s
    int16_t maxAutoClimbRate;  // Max climb rate in autonomous modes (uses `fw.max_auto_climb_rate` or `mc.max_auto_climb_rate` based on platform) | units: cm/s
...
typedef struct MSP_PACKED msp_MSP_SET_NAV_POSHOLD_request_t {
...
typedef struct MSP_PACKED msp_MSP_CALIBRATION_DATA_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_CALIBRATION_DATA_request_t {
...
typedef struct MSP_PACKED msp_MSP_POSITION_ESTIMATION_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_POSITION_ESTIMATION_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_WP_MISSION_LOAD_request_t {
...
typedef struct MSP_PACKED msp_MSP_WP_MISSION_SAVE_request_t {
    uint8_t missionID;  // Reserved for future use, currently ignored
...
typedef struct MSP_PACKED msp_MSP_WP_GETINFO_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RTH_AND_LAND_CONFIG_reply_t {
    uint16_t minRthDistance;  // Minimum distance from home required for RTH to engage (`navConfig()->general.min_rth_distance`) | units: meters
    ...
    uint8_t rthTailFirst;  // Flag: Multirotor returns tail-first (`navConfig()->general.flags.rth_tail_first`) | units: Boolean
    uint8_t rthAllowLanding;  // Flag: Allow automatic landing after RTH (`navConfig()->general.flags.rth_allow_landing`) | units: Boolean
    ?_e rthAltControlMode;  // RTH altitude control mode (`navConfig()->general.flags.rth_alt_control_mode`) | units: Enum
    uint16_t rthAbortThreshold;  // Stick input threshold to abort RTH (`navConfig()->general.rth_abort_threshold`) | units: cm/s
    uint16_t rthAltitude;  // Target RTH altitude (`navConfig()->general.rth_altitude`) | units: meters
    ...
    uint16_t landSlowdownMinAlt;  // Altitude below which `landMinAltVspd` applies (`navConfig()->general.land_slowdown_minalt`) | units: meters
    uint16_t landSlowdownMaxAlt;  // Altitude above which `landMaxAltVspd` applies (`navConfig()->general.land_slowdown_maxalt`) | units: meters
...
typedef struct MSP_PACKED msp_MSP_SET_RTH_AND_LAND_CONFIG_request_t {
    uint16_t minRthDistance;  // Sets `navConfigMutable()->general.min_rth_distance | units: meters
    ...
    ?_e rthAltControlMode;  // Sets `navConfigMutable()->general.flags.rth_alt_control_mode | units: Enum
    uint16_t rthAbortThreshold;  // Sets `navConfigMutable()->general.rth_abort_threshold | units: cm/s
    uint16_t rthAltitude;  // Sets `navConfigMutable()->general.rth_altitude | units: meters
    ...
    uint16_t landSlowdownMinAlt;  // Sets `navConfigMutable()->general.land_slowdown_minalt | units: meters
    uint16_t landSlowdownMaxAlt;  // Sets `navConfigMutable()->general.land_slowdown_maxalt | units: meters
...
typedef struct MSP_PACKED msp_MSP_FW_CONFIG_reply_t {
    uint16_t cruiseThrottle;  // Cruise throttle level (`currentBatteryProfile->nav.fw.cruise_throttle`) | units: PWM
    ...
    uint8_t pitchToThrottle;  // Pitch-to-throttle feed-forward ratio (`currentBatteryProfile->nav.fw.pitch_to_throttle`) | units: Ratio (%)
    uint16_t loiterRadius;  // Default loiter radius (`navConfig()->fw.loiter_radius`) | units: meters
...
typedef struct MSP_PACKED msp_MSP_SET_FW_CONFIG_request_t {
    ...
    uint8_t pitchToThrottle;  // Sets `currentBatteryProfileMutable->nav.fw.pitch_to_throttle | units: Ratio (%)
    uint16_t loiterRadius;  // Sets `navConfigMutable()->fw.loiter_radius | units: meters
...
typedef struct MSP_PACKED msp_MSP_MODE_RANGES_reply_t {
    ...
    uint8_t rangeStartStep;  // Start step (corresponding to channel value range 900-2100 in steps of 50/25, depends on steps calculation) | units: 0-20
    uint8_t rangeEndStep;  // End step for the activation range | units: 0-20
...
typedef struct MSP_PACKED msp_MSP_SET_MODE_RANGE_request_t {
    ...
    uint8_t rangeStartStep;  // Start step for activation | units: 0-20
    uint8_t rangeEndStep;  // End step for activation | units: 0-20
...
typedef struct MSP_PACKED msp_MSP_FEATURE_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_FEATURE_request_t {
...
typedef struct MSP_PACKED msp_MSP_BOARD_ALIGNMENT_reply_t {
    uint16_t rollAlign;  // Board alignment roll angle (`boardAlignment()->rollDeciDegrees`) | units: deci-degrees
    uint16_t pitchAlign;  // Board alignment pitch angle (`boardAlignment()->pitchDeciDegrees`) | units: deci-degrees
    uint16_t yawAlign;  // Board alignment yaw angle (`boardAlignment()->yawDeciDegrees`) | units: deci-degrees
...
typedef struct MSP_PACKED msp_MSP_SET_BOARD_ALIGNMENT_request_t {
    uint16_t rollAlign;  // Sets `boardAlignmentMutable()->rollDeciDegrees | units: deci-degrees
    uint16_t pitchAlign;  // Sets `boardAlignmentMutable()->pitchDeciDegrees | units: deci-degrees
    uint16_t yawAlign;  // Sets `boardAlignmentMutable()->yawDeciDegrees | units: deci-degrees
} msp_MSP_SET_BOARD_ALIGNMENT_request_t;

// MSP_CURRENT_METER_CONFIG (MSPv1)
// Retrieves the configuration for the current sensor.

typedef struct MSP_PACKED msp_MSP_CURRENT_METER_CONFIG_reply_t {
    uint16_t scale;  // Current sensor scale factor (`batteryMetersConfig()->current.scale`). Units depend on sensor type | units: mV/10A or similar
    uint16_t offset;  // Current sensor offset (`batteryMetersConfig()->current.offset`) | units: mV
...
typedef struct MSP_PACKED msp_MSP_SET_CURRENT_METER_CONFIG_request_t {
    uint16_t scale;  // Sets `batteryMetersConfigMutable()->current.scale | units: mV/10A or similar
    uint16_t offset;  // Sets `batteryMetersConfigMutable()->current.offset | units: mV
...
typedef struct MSP_PACKED msp_MSP_MIXER_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_MIXER_request_t {
...
typedef struct MSP_PACKED msp_MSP_RX_CONFIG_reply_t {
    rxSerialReceiverType_e serialRxProvider;  // Enum `rxSerialReceiverType_e` sets Serial RX provider type ('rxConfig()->serialrx_provider') | units: Enum
    ...
    uint16_t rxMinUsec;  // Minimum expected pulse width (`rxConfig()->rx_min_usec`) | units: µs
    uint16_t rxMaxUsec;  // Maximum expected pulse width (`rxConfig()->rx_max_usec`) | units: µs
...
typedef struct MSP_PACKED msp_MSP_SET_RX_CONFIG_request_t {
    rxSerialReceiverType_e serialRxProvider;  // Enum `rxSerialReceiverType_e` Serial RX provider type ('rxConfig()->serialrx_provider') | units: Enum
    ...
    uint16_t rxMinUsec;  // Sets `rxConfigMutable()->rx_min_usec | units: µs
    uint16_t rxMaxUsec;  // Sets `rxConfigMutable()->rx_max_usec | units: µs
...
typedef struct MSP_PACKED msp_MSP_LED_COLORS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_LED_COLORS_request_t {
    uint16_t hue;  // Hue value (0-359)
    uint8_t saturation;  // Saturation value (0-255)
    uint8_t value;  // Value/Brightness (0-255)
...
typedef struct MSP_PACKED msp_MSP_LED_STRIP_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_LED_STRIP_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_RSSI_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RSSI_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_ADJUSTMENT_RANGES_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_ADJUSTMENT_RANGE_request_t {
...
typedef struct MSP_PACKED msp_MSP_VOLTAGE_METER_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_VOLTAGE_METER_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_SONAR_ALTITUDE_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RX_MAP_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RX_MAP_request_t {
...
typedef struct MSP_PACKED msp_MSP_DATAFLASH_SUMMARY_reply_t {
...
typedef struct MSP_PACKED msp_MSP_DATAFLASH_READ_request_t {
...
typedef struct MSP_PACKED msp_MSP_DATAFLASH_READ_reply_t {
...
typedef struct MSP_PACKED msp_MSP_LOOP_TIME_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_LOOP_TIME_request_t {
...
typedef struct MSP_PACKED msp_MSP_FAILSAFE_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_FAILSAFE_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_SDCARD_SUMMARY_reply_t {
...
typedef struct MSP_PACKED msp_MSP_BLACKBOX_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_OSD_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_OSD_CONFIG_reply_t_dataSize_ge_10 {
    videoSystem_e videoSystem;  // Enum `videoSystem_e`: Video system (Auto/PAL/NTSC) (`osdConfig()->video_system`). Sent even if OSD disabled | units: Enum
    osd_unit_e units;  // Enum `osd_unit_e` Measurement units (Metric/Imperial) (`osdConfig()->units`). Sent even if OSD disabled | units: Enum
    uint8_t rssiAlarm;  // RSSI alarm threshold (`osdConfig()->rssi_alarm`). Sent even if OSD disabled | units: %
    uint16_t capAlarm;  // Capacity alarm threshold (`currentBatteryProfile->capacity.warning`). Sent even if OSD disabled | units: mAh/mWh
    ...
    uint16_t distAlarm;  // Distance alarm threshold (`osdConfig()->dist_alarm`). Sent even if OSD disabled | units: meters
    uint16_t negAltAlarm;  // Negative altitude alarm threshold (`osdConfig()->neg_alt_alarm`). Sent even if OSD disabled | units: meters
} msp_MSP_SET_OSD_CONFIG_reply_t_dataSize_ge_10;

typedef struct MSP_PACKED msp_MSP_SET_OSD_CONFIG_request_t_dataSize_eq_3 {
    uint16_t itemPositions[OSD_ITEM_COUNT];  // Packed X/Y position for each OSD item on screen 0 (`osdLayoutsConfig()->item_pos[0][i]`). Sent even if OSD disabled | units: Coordinates
} msp_MSP_SET_OSD_CONFIG_request_t_dataSize_eq_3;
...
typedef struct MSP_PACKED msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_BYTES___2 {
    uint16_t address;  // 16-bit character address
    uint8_t charData[OSD_CHAR_BYTES];  // Full character bytes (with metadata)
} msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_BYTES___2;

typedef struct MSP_PACKED msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_BYTES___1 {
    uint8_t address;  // 8-bit character address
    uint8_t charData[OSD_CHAR_BYTES];  // Full character bytes (with metadata)
} msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_BYTES___1;

typedef struct MSP_PACKED msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_VISIBLE_BYTES___2 {
    uint16_t address;  // 16-bit character address
    uint8_t charData[OSD_CHAR_VISIBLE_BYTES];  // Only visible character bytes (no metadata)
} msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_VISIBLE_BYTES___2;

typedef struct MSP_PACKED msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_VISIBLE_BYTES___1 {
    uint8_t address;  // 8-bit character address
    uint8_t charData[OSD_CHAR_VISIBLE_BYTES];  // Only visible character bytes (no metadata)
} msp_MSP_OSD_CHAR_WRITE_request_t_dataSize_ge_OSD_CHAR_VISIBLE_BYTES___1;
...
typedef struct MSP_PACKED msp_MSP_VTX_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_2 {
...
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_2;

typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_4 {
...
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_4;

typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_5 {
    uint16_t bandChanOrFreq;
    uint8_t power;
    uint8_t pitMode;
    vtxLowerPowerDisarm_e lowPowerDisarm;  // VTX_LOW_POWER_DISARM_OFF=0, ALWAYS=1, UNTIL_FIRST_ARM=2
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_5;

typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_7 {
    uint16_t bandChanOrFreq;
    uint8_t power;
    uint8_t pitMode;
    vtxLowerPowerDisarm_e lowPowerDisarm;
    uint16_t pitModeFreq;  // Read and skipped in this implementation.
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_7;

typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_9 {
    uint16_t bandChanOrFreq;
    uint8_t power;
    uint8_t pitMode;
    vtxLowerPowerDisarm_e lowPowerDisarm;
...
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_9;

typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_11 {
    uint16_t bandChanOrFreq;
    uint8_t power;
    uint8_t pitMode;
    vtxLowerPowerDisarm_e lowPowerDisarm;
...
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_11;

typedef struct MSP_PACKED msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_14 {
    uint16_t bandChanOrFreq;
    uint8_t power;
    uint8_t pitMode;
    vtxLowerPowerDisarm_e lowPowerDisarm;
...
} msp_MSP_SET_VTX_CONFIG_request_t_dataSize_eq_14;
...
typedef struct MSP_PACKED msp_MSP_ADVANCED_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_ADVANCED_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_FILTER_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_FILTER_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_PID_ADVANCED_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_PID_ADVANCED_request_t {
...
typedef struct MSP_PACKED msp_MSP_SENSOR_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_SENSOR_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP_IDENT_reply_t {
...
typedef struct MSP_PACKED msp_MSP_STATUS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RAW_IMU_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SERVO_reply_t {
...
typedef struct MSP_PACKED msp_MSP_MOTOR_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RC_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RAW_GPS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_COMP_GPS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_ATTITUDE_reply_t {
...
typedef struct MSP_PACKED msp_MSP_ALTITUDE_reply_t {
...
typedef struct MSP_PACKED msp_MSP_ANALOG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RC_TUNING_reply_t {
...
typedef struct MSP_PACKED msp_MSP_ACTIVEBOXES_reply_t {
...
typedef struct MSP_PACKED msp_MSP_MISC_reply_t {
...
typedef struct MSP_PACKED msp_MSP_BOXNAMES_reply_t {
...
typedef struct MSP_PACKED msp_MSP_PIDNAMES_reply_t {
...
typedef struct MSP_PACKED msp_MSP_BOXIDS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SERVO_CONFIGURATIONS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_NAV_STATUS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_3D_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RC_DEADBAND_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SENSOR_ALIGNMENT_reply_t {
...
typedef struct MSP_PACKED msp_MSP_LED_STRIP_MODECOLOR_reply_t {
...
typedef struct MSP_PACKED msp_MSP_BATTERY_STATE_reply_t {
...
typedef struct MSP_PACKED msp_MSP_VTXTABLE_POWERLEVEL_request_t {
    uint8_t powerLevelIndex;  // 1-based index of the power level to query
} msp_MSP_VTXTABLE_POWERLEVEL_request_t;

typedef struct MSP_PACKED msp_MSP_VTXTABLE_POWERLEVEL_reply_t {
...
typedef struct MSP_PACKED msp_MSP_STATUS_EX_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SENSOR_STATUS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_UID_reply_t {
...
typedef struct MSP_PACKED msp_MSP_GPSSVINFO_reply_t {
...
typedef struct MSP_PACKED msp_MSP_GPSSTATISTICS_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_TX_INFO_request_t {
...
typedef struct MSP_PACKED msp_MSP_TX_INFO_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RAW_RC_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RAW_GPS_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RC_TUNING_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_MISC_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_WP_request_t {
...
typedef struct MSP_PACKED msp_MSP_SELECT_SETTING_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_HEAD_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_SERVO_CONFIGURATION_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_MOTOR_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_3D_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RC_DEADBAND_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_SENSOR_ALIGNMENT_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_LED_STRIP_MODECOLOR_request_t {
...
typedef struct MSP_PACKED msp_MSP_SERVO_MIX_RULES_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_SERVO_MIX_RULE_request_t {
...
typedef struct MSP_PACKED msp_MSP_SET_PASSTHROUGH_reply_t {
...
typedef struct MSP_PACKED msp_MSP_RTC_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SET_RTC_request_t {
...
typedef struct MSP_PACKED msp_MSP_DEBUGMSG_reply_t {
...
typedef struct MSP_PACKED msp_MSP_DEBUG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_TZ_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_TZ_request_t_dataSize_eq_2 {
    int16_t tz_offset;  // Timezone offset from UTC. | units: minutes
} msp_MSP2_COMMON_SET_TZ_request_t_dataSize_eq_2;

typedef struct MSP_PACKED msp_MSP2_COMMON_SET_TZ_request_t_dataSize_eq_3 {
    int16_t tz_offset;  // Timezone offset from UTC. | units: minutes
    uint8_t tz_automatic_dst;  // Automatic DST enable (0/1). | units: bool
} msp_MSP2_COMMON_SET_TZ_request_t_dataSize_eq_3;
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SETTING_request_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SETTING_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_SETTING_request_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_MOTOR_MIXER_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_MOTOR_MIXER_request_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SETTING_INFO_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_PG_LIST_request_t {
    uint16_t pgn;  // (Optional) PGN ID to query. If omitted, returns all used PGNs
} msp_MSP2_COMMON_PG_LIST_request_t;

typedef struct MSP_PACKED msp_MSP2_COMMON_PG_LIST_reply_t {
    uint16_t pgn;  // Parameter Group Number (PGN) ID
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SERIAL_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_SERIAL_CONFIG_request_t {
    serialPortIdentifier_e identifier;  // Port identifier Enum (`serialPortIdentifier_e`)
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_RADAR_POS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_MSP_RC_LINK_STATS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_COMMON_SET_MSP_RC_INFO_request_t {
    uint8_t sublinkID;  // Sublink identifier (usually 0)
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_RANGEFINDER_request_t {
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_OPTIC_FLOW_request_t {
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_GPS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_COMPASS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_BAROMETER_request_t {
    uint8_t instance;  // Sensor instance number
    uint32_t timeMs;  // Timestamp from the sensor | units: ms
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_AIRSPEED_request_t {
    uint8_t instance;  // Sensor instance number
    uint32_t timeMs;  // Timestamp from the sensor | units: ms
...
typedef struct MSP_PACKED msp_MSP2_SENSOR_HEADTRACKER_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_STATUS_reply_t {
    uint16_t cycleTime;  // Main loop cycle time | units: µs
    uint16_t i2cErrors;  // I2C errors | units: Count
    uint16_t sensorStatus;  // Bitmask: Sensor status | units: Bitmask
...
typedef struct MSP_PACKED msp_MSP2_INAV_OPTICAL_FLOW_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_ANALOG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_MISC_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_MISC_request_t {
    uint16_t midRc;  // Ignored | units: PWM
    uint16_t legacyMinThrottle;  // Ignored
    uint16_t legacyMaxThrottle;  // Ignored
...
typedef struct MSP_PACKED msp_MSP2_INAV_BATTERY_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_BATTERY_CONFIG_request_t {
    uint16_t vbatScale;  // Sets `batteryMetersConfigMutable()->voltage.scale` (if `USE_ADC`) | units: Scale
    batVoltageSource_e vbatSource;  // Enum `batVoltageSource_e` Sets `batteryMetersConfigMutable()->voltageSource` (if `USE_ADC`, validated) | units: Enum
    uint8_t cellCount;  // Sets `currentBatteryProfileMutable->cells` (if `USE_ADC`) | units: Count
    uint16_t vbatCellDetect;  // Sets `currentBatteryProfileMutable->voltage.cellDetect` (if `USE_ADC`) | units: 0.01V
...
typedef struct MSP_PACKED msp_MSP2_INAV_RATE_PROFILE_reply_t {
    uint8_t throttleMid;  // Throttle Midpoint (`currentControlRateProfile->throttle.rcMid8`)
    uint8_t throttleExpo;  // Throttle Expo (`currentControlRateProfile->throttle.rcExpo8`)
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_RATE_PROFILE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_AIR_SPEED_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OUTPUT_MAPPING_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_MC_BRAKING_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_MC_BRAKING_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OUTPUT_MAPPING_EXT_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_TIMER_OUTPUT_MODE_request_t_dataSize_eq_1 {
    uint8_t timerIndex;  // 0..HARDWARE_TIMER_DEFINITION_COUNT-1
} msp_MSP2_INAV_TIMER_OUTPUT_MODE_request_t_dataSize_eq_1;
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_TIMER_OUTPUT_MODE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_MIXER_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_MIXER_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OSD_LAYOUTS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OSD_SET_LAYOUT_ITEM_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OSD_ALARMS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OSD_SET_ALARMS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OSD_PREFERENCES_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_OSD_SET_PREFERENCES_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SELECT_BATTERY_PROFILE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_DEBUG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_BLACKBOX_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_SET_BLACKBOX_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_TEMP_SENSOR_CONFIG_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_TEMP_SENSOR_CONFIG_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_TEMPERATURES_reply_t {
...
typedef struct MSP_PACKED msp_MSP_SIMULATOR_request_t {
...
typedef struct MSP_PACKED msp_MSP_SIMULATOR_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SERVO_MIXER_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_SERVO_MIXER_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_LOGIC_CONDITIONS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_LOGIC_CONDITIONS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_LOGIC_CONDITIONS_STATUS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_GVAR_STATUS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_PROGRAMMING_PID_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_PROGRAMMING_PID_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_PROGRAMMING_PID_STATUS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_PID_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_SET_PID_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_FWUPDT_PREPARE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_FWUPDT_STORE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_FWUPDT_EXEC_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SAFEHOME_request_t {
    uint8_t safehomeIndex;  // Index of the safe home location (0 to `MAX_SAFE_HOMES - 1`)
} msp_MSP2_INAV_SAFEHOME_request_t;

typedef struct MSP_PACKED msp_MSP2_INAV_SAFEHOME_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_SAFEHOME_request_t {
    uint8_t safehomeIndex;  // Index of the safe home location (0 to `MAX_SAFE_HOMES - 1`)
...
typedef struct MSP_PACKED msp_MSP2_INAV_MISC2_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_LOGIC_CONDITIONS_SINGLE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_LOGIC_CONDITIONS_SINGLE_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_ESC_RPM_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_ESC_TELEM_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_LED_STRIP_CONFIG_EX_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_LED_STRIP_CONFIG_EX_request_t {
    uint8_t ledIndex;  // Index of the LED to configure (0 to `LED_MAX_STRIP_LENGTH - 1`)
    uint16_t ledConfig;
...
typedef struct MSP_PACKED msp_MSP2_INAV_FW_APPROACH_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_FW_APPROACH_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_FW_APPROACH_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_GPS_UBLOX_COMMAND_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_RATE_DYNAMICS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_RATE_DYNAMICS_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_EZ_TUNE_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_EZ_TUNE_SET_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SELECT_MIXER_PROFILE_request_t {
...
typedef struct MSP_PACKED msp_MSP2_ADSB_VEHICLE_LIST_reply_t {
    ...
    struct MSP_PACKED msp_MSP2_ADSB_VEHICLE_LIST_reply_t__repeating_t {
    adsbVehicle_t adsbVehicle[];  // Array of `adsbVehicle_t` Repeated `maxVehicles` times
    };
    struct msp_MSP2_ADSB_VEHICLE_LIST_reply_t__repeating_t items[];  // count by field or macro: maxVehicles
...
typedef struct MSP_PACKED msp_MSP2_INAV_CUSTOM_OSD_ELEMENTS_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_CUSTOM_OSD_ELEMENT_request_t {
    uint8_t elementIndex;  // Index of the custom element (0 to `MAX_CUSTOM_ELEMENTS - 1`)
} msp_MSP2_INAV_CUSTOM_OSD_ELEMENT_request_t;

typedef struct MSP_PACKED msp_MSP2_INAV_CUSTOM_OSD_ELEMENT_reply_t {
    // Repeating block: CUSTOM_ELEMENTS_PARTS
    struct MSP_PACKED msp_MSP2_INAV_CUSTOM_OSD_ELEMENT_reply_t__repeating_t {
    osdCustomElementType_e partType;  // Type of this part
    uint16_t partValue;  // Value/ID associated with this part
    };
    struct msp_MSP2_INAV_CUSTOM_OSD_ELEMENT_reply_t__repeating_t items[];  // count by field or macro: CUSTOM_ELEMENTS_PARTS
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_CUSTOM_OSD_ELEMENTS_request_t {
    uint8_t elementIndex;  // Index of the custom element (0 to `MAX_CUSTOM_ELEMENTS - 1`)
    // Repeating block: CUSTOM_ELEMENTS_PARTS
    struct MSP_PACKED msp_MSP2_INAV_SET_CUSTOM_OSD_ELEMENTS_request_t__repeating_t {
    osdCustomElementType_e partType;  // Type of this part
    uint16_t partValue;  // Value/ID associated with this part
    };
    struct msp_MSP2_INAV_SET_CUSTOM_OSD_ELEMENTS_request_t__repeating_t items[];  // count by field or macro: CUSTOM_ELEMENTS_PARTS
    osdCustomElementTypeVisibility_e visibilityType;  // Visibility condition source
    uint16_t visibilityValue;  // Value/ID of the visibility condition source
    char elementText[OSD_CUSTOM_ELEMENT_TEXT_SIZE - 1];  // Raw bytes
} msp_MSP2_INAV_SET_CUSTOM_OSD_ELEMENTS_request_t;
...
typedef struct MSP_PACKED msp_MSP2_INAV_OUTPUT_MAPPING_EXT2_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SERVO_CONFIG_reply_t {
    uint16_t min;  // Minimum servo endpoint (`servoParams(i)->min`) | units: PWM
    uint16_t max;  // Maximum servo endpoint (`servoParams(i)->max`) | units: PWM
    uint16_t middle;  // Middle/Neutral servo position (`servoParams(i)->middle`) | units: PWM
    uint8_t rate;  // Servo rate/scaling (`servoParams(i)->rate`) | units: % (-100 to 100)
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_SERVO_CONFIG_request_t {
    uint8_t servoIndex;  // Index of the servo to configure (0 to `MAX_SUPPORTED_SERVOS - 1`) | units: Index
...
typedef struct MSP_PACKED msp_MSP2_INAV_GEOZONE_request_t {
    uint8_t geozoneIndex;  // Index of the geozone (0 to `MAX_GEOZONES_IN_CONFIG - 1`)
} msp_MSP2_INAV_GEOZONE_request_t;

typedef struct MSP_PACKED msp_MSP2_INAV_GEOZONE_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_GEOZONE_request_t {
    uint8_t geozoneIndex;  // Index of the geozone (0 to `MAX_GEOZONES_IN_CONFIG - 1`)
    uint8_t type;  // Define (`GEOZONE_TYPE_EXCLUSIVE/INCLUSIVE`): Zone type (Inclusion/Exclusion)
    uint8_t shape;  // Define (`GEOZONE_SHAPE_CIRCULAR/POLYGHON`): Zone shape (Polygon/Circular)
...
typedef struct MSP_PACKED msp_MSP2_INAV_GEOZONE_VERTEX_request_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_GEOZONE_VERTEX_reply_t {
...
typedef struct MSP_PACKED msp_MSP2_INAV_SET_GEOZONE_VERTEX_request_t_polygon {
    uint8_t geozoneIndex;  // Geozone index requested | units: Index
    uint8_t vertexId;  // Vertex index requested | units: Index
    int32_t latitude;  // Vertex latitude | units: deg * 1e7
    int32_t longitude;  // Vertex longitude | units: deg * 1e7
} msp_MSP2_INAV_SET_GEOZONE_VERTEX_request_t_polygon;

typedef struct MSP_PACKED msp_MSP2_INAV_SET_GEOZONE_VERTEX_request_t_circle {
    uint8_t geozoneIndex;  // Geozone index requested | units: Index
    uint8_t vertexId;  // Vertex index requested | units: Index
...
} msp_MSP2_INAV_SET_GEOZONE_VERTEX_request_t_circle;
