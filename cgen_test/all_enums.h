// Consolidated enums — generated on 2025-12-17T14:02:20
...
typedef enum {
    ADCINVALID = -1,
    ADCDEV_1 = 0,
    ADCDEV_2 = (1), // requires STM32F4 || STM32F7 || STM32H7
    ADCDEV_3 = (2), // requires STM32F4 || STM32F7 || STM32H7
    ADCDEV_MAX = ADCDEV_1, // requires NOT(STM32F4 || STM32F7 || STM32H7)
...
typedef enum {
    ...
    AFATFS_FILE_OPERATION_APPEND_SUPERCLUSTER = (6), // requires AFATFS_USE_FREEFILE
    AFATFS_FILE_OPERATION_LOCKED = (7), // requires AFATFS_USE_FREEFILE
...
typedef enum {
    ...
    AFATFS_INITIALIZATION_FREEFILE_CREATE = (2), // requires AFATFS_USE_FREEFILE
    AFATFS_INITIALIZATION_FREEFILE_CREATING = (3), // requires AFATFS_USE_FREEFILE
    AFATFS_INITIALIZATION_FREEFILE_FAT_SEARCH = (4), // requires AFATFS_USE_FREEFILE
    AFATFS_INITIALIZATION_FREEFILE_UPDATE_FAT = (5), // requires AFATFS_USE_FREEFILE
    AFATFS_INITIALIZATION_FREEFILE_SAVE_DIR_ENTRY = (6), // requires AFATFS_USE_FREEFILE
    AFATFS_INITIALIZATION_FREEFILE_LAST = AFATFS_INITIALIZATION_FREEFILE_SAVE_DIR_ENTRY, // requires AFATFS_USE_FREEFILE
...
typedef enum {
    ...
    AFATFS_TRUNCATE_FILE_ERASE_FAT_CHAIN_CONTIGUOUS = (2), // requires AFATFS_USE_FREEFILE
    AFATFS_TRUNCATE_FILE_PREPEND_TO_FREEFILE = (3), // requires AFATFS_USE_FREEFILE
...
typedef enum {
    ...
    I2CDEV_2 = 1,
    I2CDEV_3 = 2,
    I2CDEV_4 = (3), // requires USE_I2C_DEVICE_4
    I2CDEV_COUNT = 4,
} I2CDevice;
...
typedef enum {
    ...
    LOGIC_CONDITION_GLOBAL_FLAG_DISABLE_GPS_FIX = (1 << 11), // requires USE_GPS_FIX_ESTIMATION
...
typedef enum {
    ...
    LTM_SFRAME,
    LTM_GFRAME, // requires USE_GPS
    LTM_OFRAME, // requires USE_GPS
    LTM_XFRAME, // requires USE_GPS
    LTM_NFRAME,
    LTM_FRAME_COUNT,
} ltm_frame_e;
...
typedef enum {
    ...
    AUX13 = 16,
    AUX14 = 17,
    AUX15 = (18), // requires USE_34CHANNELS
    AUX16 = (19), // requires USE_34CHANNELS
    AUX17 = (20), // requires USE_34CHANNELS
    AUX18 = (21), // requires USE_34CHANNELS
    AUX19 = (22), // requires USE_34CHANNELS
    AUX20 = (23), // requires USE_34CHANNELS
    AUX21 = (24), // requires USE_34CHANNELS
    AUX22 = (25), // requires USE_34CHANNELS
    AUX23 = (26), // requires USE_34CHANNELS
    AUX24 = (27), // requires USE_34CHANNELS
    AUX25 = (28), // requires USE_34CHANNELS
    AUX26 = (29), // requires USE_34CHANNELS
    AUX27 = (30), // requires USE_34CHANNELS
    AUX28 = (31), // requires USE_34CHANNELS
    AUX29 = (32), // requires USE_34CHANNELS
    AUX30 = (33), // requires USE_34CHANNELS
} rc_alias_e;
...
typedef enum {
    ...
    GPS_ESTIMATED_FIX = (1 << 10), // requires USE_GPS_FIX_ESTIMATION
...
typedef enum {
    ...
    timBattery = 2,
    timRssi = 3,
    timGps = (4), // requires USE_GPS
    timWarning = 5,
    timIndicator = 6,
    timAnimation = (7), // requires USE_LED_ANIMATION
    timRing = 8,
    timTimerCount = 9,
} timId_e;
