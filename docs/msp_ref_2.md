...
| `vbatSource` | `uint8_t` | 1 | [ENUM_NAME](LINK_TO_ENUM) | Voltage source (`batteryMetersConfig()->voltageSource`). 0 if `USE_ADC` disabled |
...
| `vbatSource` | `uint8_t` | 1 | [ENUM_NAME](LINK_TO_ENUM) | Sets `batteryMetersConfigMutable()->voltageSource` (if `USE_ADC`, validated) |
...
| `vbatSource` | `uint8_t` | 1 | [ENUM_NAME](LINK_TO_ENUM) | Voltage source (`batteryMetersConfig()->voltageSource`) |
