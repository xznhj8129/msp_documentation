...
- [MSP_TRANSPONDER_CONFIG (82 / 0x52)](#msp_transponder_config)
...
- [MSP_SET_WP (209 / 0xd1)](#msp_set_wp)
...
| `magHardware` | `uint8_t` | 1 | [magHardware_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-maghardware_e) | Enum (`magHardware_e`): Magnetometer hardware type (`compassConfig()->mag_hardware`). 0 if `USE_MAG` disabled |
| `pitotHardware` | `uint8_t` | 1 | [pitotHardware_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-pitothardware_e) | Enum (`pitotHardware_e`): Pitot tube hardware type (`pitotmeterConfig()->pitot_hardware`). 0 if `USE_PITOT` disabled |
| `rangefinderHardware` | `uint8_t` | 1 | [rangefinderHardware_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-rangefinderhardware_e) | Enum (`rangefinderHardware_e`): Rangefinder hardware type (`rangefinderConfig()->rangefinder_hardware`). 0 if `USE_RANGEFINDER` disabled |
| `opflowHardware` | `uint8_t` | 1 | [opticalFlowHardware_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-opticalflowhardware_e) | Enum (`opticalFlowHardware_e`): Optical flow hardware type (`opticalFlowConfig()->opflow_hardware`). 0 if `USE_OPFLOW` disabled |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `fixType` | `uint8_t` | 1 | [gpsFixType_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-gpsfixtype_e) | Enum `gpsFixType_e` GPS fix type (`gpsSol.fixType`) |
...
| `gpsType` | `uint8_t` | 1 | [gpsProvider_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-gpsprovider_e) | Enum `gpsProvider_e` GPS provider type (`gpsConfig()->provider`). 0 if `USE_GPS` disabled |
| `legacyGpsBaud` | `uint8_t` | 1 | - | Always 0 (Legacy) |
| `gpsSbasMode` | `uint8_t` | 1 | [sbasMode_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-sbasmode_e) | Enum `sbasMode_e` GPS SBAS mode (`gpsConfig()->sbasMode`). 0 if `USE_GPS` disabled |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `modeIndex` | `uint8_t` | 1 | [ledModeIndex_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-ledmodeindex_e) | Index of the LED mode Enum (`ledModeIndex_e`). `LED_MODE_COUNT` for special colors |
| `directionOrSpecialIndex` | `uint8_t` | 1 | [ledDirection_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-leddirection_e) | Index of the direction Enum (`ledDirection_e`) or special color (`ledSpecialColor_e`) |
...
| `batteryState` | `uint8_t` | 1 | [batteryState_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-batterystate_e) | Enum `batteryState_e` Current battery state (`getBatteryState()`, see `BATTERY_STATE_*`) |
...
| `gyroStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Gyro hardware status (`getHwGyroStatus()`) |
| `accStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Accelerometer hardware status (`getHwAccelerometerStatus()`) |
| `magStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Compass hardware status (`getHwCompassStatus()`) |
| `baroStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Barometer hardware status (`getHwBarometerStatus()`) |
| `gpsStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` GPS hardware status (`getHwGPSStatus()`) |
| `rangefinderStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Rangefinder hardware status (`getHwRangefinderStatus()`) |
| `pitotStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Pitot hardware status (`getHwPitotmeterStatus()`) |
| `opflowStatus` | `uint8_t` | 1 | [hardwareSensorStatus_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-hardwaresensorstatus_e) | Enum `hardwareSensorStatus_e` Optical Flow hardware status (`getHwOpticalFlowStatus()`) |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `rssiSource` | `uint8_t` | 1 | [getRSSISource()](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-getrssisource()) | Enum: Source of the RSSI value (`getRSSISource()`) |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `fixType` | `uint8_t` | 1 | [gpsFixType_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-gpsfixtype_e) | Enum `gpsFixType_e` GPS fix type |
...
| `gpsType` | `uint8_t` | 1 | [gpsProvider_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-gpsprovider_e) | Enum `gpsProvider_e` (Sets `gpsConfigMutable()->provider`) |
| `legacyGpsBaud` | `uint8_t` | 1 | - | Ignored |
| `gpsSbasMode` | `uint8_t` | 1 | [sbasMode_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-sbasmode_e) | Enum `sbasMode_e` (Sets `gpsConfigMutable()->sbasMode`) |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `identifier` | `uint8_t` | 1 | [serialPortIdentifier_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-serialportidentifier_e) | Port identifier Enum (`serialPortIdentifier_e`) |
...
| `fixType` | `uint8_t` | 1 | [gpsFixType_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-gpsfixtype_e) | Enum `gpsFixType_e` Type of GPS fix |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `batteryFlags` | `uint8_t` | 1 | [getBatteryState()](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-getbatterystate()) | Battery status flags: Bit 0=Full on plug-in, Bit 1=Use capacity threshold, Bit 2-3=Battery State enum (`getBatteryState()`), Bit 4-7=Cell Count (`getBatteryCellCount()`) |
...
| `vbatSource` | `uint8_t` | 1 | [batVoltageSource_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-batvoltagesource_e) | Enum `batVoltageSource_e` Voltage source (`batteryMetersConfig()->voltageSource`). 0 if `USE_ADC` disabled |
...
| `capacityUnit` | `uint8_t` | 1 | [batCapacityUnit_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-batcapacityunit_e) | Enum `batCapacityUnit_e` Capacity unit ('batteryMetersConfig()->capacity_unit') |
...
| `gpsType` | `uint8_t` | 1 | [gpsProvider_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-gpsprovider_e) | Enum `gpsProvider_e` Sets `gpsConfigMutable()->provider` (if `USE_GPS`) |
| `legacyGpsBaud` | `uint8_t` | 1 | - | Ignored |
| `gpsSbasMode` | `uint8_t` | 1 | [sbasMode_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-sbasmode_e) | Enum `sbasMode_e` Sets `gpsConfigMutable()->sbasMode` (if `USE_GPS`) |
...
| `vbatSource` | `uint8_t` | 1 | [batVoltageSource_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-batvoltagesource_e) | Enum `batVoltageSource_e` Sets `batteryMetersConfigMutable()->voltageSource` (if `USE_ADC`, validated) |
...
| `capacityUnit` | `uint8_t` | 1 | [batCapacityUnit_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-batcapacityunit_e) | Enum `batCapacityUnit_e` sets Capacity unit ('batteryMetersConfig()->capacity_unit'). Updates OSD energy unit if changed |
...
| `vbatSource` | `uint8_t` | 1 | [batVoltageSource_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-batvoltagesource_e) | Enum `batVoltageSource_e` Voltage source (`batteryMetersConfig()->voltageSource`) |
...
| `outputMode` | `uint8_t` | 1 | [TIMER_OUTPUT_MODE_*](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-timer_output_mode_*) | Output mode override (`TIMER_OUTPUT_MODE_*` enum) |
...
| `outputMode` | `uint8_t` | 1 | [TIMER_OUTPUT_MODE_*](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-timer_output_mode_*) | Output mode override (`TIMER_OUTPUT_MODE_*` enum) to set |
...
| `platformType` | `uint8_t` | 1 | [platformType_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-platformtype_e) | Enum (`platformType_e`): Vehicle platform type (Multirotor, Airplane, etc.) (`mixerConfig()->platformType`) |
| `hasFlaps` | `uint8_t` | 1 | - | Boolean: 1 if the current mixer configuration includes flaps (`mixerConfig()->hasFlaps`) |
| `appliedMixerPreset` | `uint16_t` | 2 | [mixerPreset_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-mixerpreset_e) | Enum (`mixerPreset_e`): Mixer preset currently applied (`mixerConfig()->appliedMixerPreset`) |
...
| `itemIndex` | `uint8_t` | 1 | [OSD_ITEM_*](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-osd_item_*) | Index of the OSD item (`OSD_ITEM_*` enum) |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `videoSystem` | `uint8_t` | 1 | [osdConfig()->video_system](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-osdconfig()->video_system) | Enum: Video system (Auto/PAL/NTSC) (`osdConfig()->video_system`) |
...
| `crosshairsStyle` | `uint8_t` | 1 | [osdConfig()->crosshairs_style](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-osdconfig()->crosshairs_style) | Enum: Style of the center crosshairs (`osdConfig()->crosshairs_style`) |
...
| `units` | `uint8_t` | 1 | [osd_unit_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-osd_unit_e) | Enum: `osd_unit_e` Measurement units (Metric/Imperial) (`osdConfig()->units`) |
| `statsEnergyUnit` | `uint8_t` | 1 | [osdConfig()->stats_energy_unit](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-osdconfig()->stats_energy_unit) | Enum: Unit for energy display in post-flight stats (`osdConfig()->stats_energy_unit`) |
...
| `units` | `uint8_t` | 1 | [osd_unit_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-osd_unit_e) | Enum `osd_unit_e` Sets `osdConfigMutable()->units |
...
| `blackboxDevice` | `uint8_t` | 1 | [blackboxDevice_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-blackboxdevice_e) | Enum (`blackboxDevice_e`): Target device for logging (`blackboxConfig()->device`). 0 if not supported |
...
| Field | C Type | Size (Bytes) | Units | Description |
|---|---|---|---|---|
| `type` | `uint8_t` | 1 | [tempSensorType_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-tempsensortype_e) | Enum (`tempSensorType_e`): Type of the temperature sensor |
...
| `approachDirection` | `uint8_t` | 1 | [fwAutolandApproachDirection_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-fwautolandapproachdirection_e) | Enum `fwAutolandApproachDirection_e`: Direction of approach (From WP, Specific Heading) |
...
| `approachDirection` | `uint8_t` | 1 | [fwAutolandApproachDirection_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-fwautolandapproachdirection_e) | Enum `fwAutolandApproachDirection_e` Sets approach direction |
...
| `pinLabel` | `uint8_t` | 1 | [PIN_LABEL_*](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-pin_label_*) | Label for special pin usage (`PIN_LABEL_*` enum, e.g., `PIN_LABEL_LED`). 0 (`PIN_LABEL_NONE`) otherwise |
...
| `isSeaLevelRef` | `uint8_t` | 1 | - | Boolean: 1 if altitudes are relative to sea level, 0 if relative to home |
| `fenceAction` | `uint8_t` | 1 | [geozoneActionState_e](https://github.com/xznhj8129/msp_documentation/blob/master/docs/inav_enums_ref.md#enum-geozoneactionstate_e) | Enum (`geozoneActionState_e`): Action to take upon boundary violation |
